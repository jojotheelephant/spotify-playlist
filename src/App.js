...
function App() {
    ...
    // ----- SPOTIFY API HANDLER METHODS -----
    // Get userInfo from SpotifyAPI.js and save to state  ~~ not complete
    const currentUserInfo = () => {
        console.log(`Grabbing User information from Spotify`);
        SpotifyAPI.getUserInfo()
            .then(
                (returnedUserInfo) => {
                    setUserInfo(returnedUserInfo);
            ...
            .then(console.log(`UserInfo Updated: ${userInfo}`));
    };
